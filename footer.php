...
<script src='<?php cjUrl('viewimage.js') ?>'></script>
<script>
    function ViewImage() {
        jQuery.viewImage({
            'target' : '.post img',
